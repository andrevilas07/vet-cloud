...
import { adicionarAgendamento, atualizarAgendamento, excluirAgendamento, excluirAgendamentos, obterAgendamento, obterAgendamentosPor, obterAgendamentos } from "~/services/agendamento-service";
